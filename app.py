...
def index():  # 一个分片上传后被调用
    ...
    return render_template('upload.html', dir=upload_dir, files=get_files())
...
def after_upload(file):
    # the param 'file' is the filename of the upload video
    # Save the output video file in static folder with the name of param 'file'
